...
public abstract class CustomShape implements java.io.Serializable {

	private static final long serialVersionUID = -4924993549532748541L;
	...
	public void drawDash(Graphics2D g) {
		Stroke dashed = new BasicStroke(colorBundle.getStrokeThickness(), BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL,
				0, new float[] { 9 }, 0);
