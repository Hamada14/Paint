...
public class Triangle extends CustomShape implements java.io.Serializable {

	private static final long serialVersionUID = -6508774464757549547L;
	private Point thirdPnt;

	public Triangle(Point cntrPnt, Point refPnt, Point thirdPnt, ColorBundle colorBundle) {
	...
	public void move(Point start, Point end) {
		...
		cntrPnt.setLocation(cntrPnt.getX() + dif.getX(), cntrPnt.getY() + dif.getY());
		refPnt.setLocation(refPnt.getX() + dif.getX(), refPnt.getY() + dif.getY());
		thirdPnt.setLocation(thirdPnt.getX() + dif.getX(), thirdPnt.getY() + dif.getY());
	}
